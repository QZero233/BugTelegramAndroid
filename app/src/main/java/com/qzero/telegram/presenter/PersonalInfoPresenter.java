...
public class PersonalInfoPresenter extends BasePresenter<PersonalInfoContract.View> implements PersonalInfoContract.Presenter {
    ...
    public void loadPersonalInfo() {
        ...
        try {
            UserInfo userInfo=localDataStorage.getObject(LocalDataStorage.NAME_PERSONAL_INFO,UserInfo.class);
    ...
    public void updatePersonalInfo(UserInfo userInfo) {
        ...
        UserInfoModule userInfoModule=new UserInfoModuleImpl(context);
        userInfoModule.updatePersonalInfo(userInfo)
